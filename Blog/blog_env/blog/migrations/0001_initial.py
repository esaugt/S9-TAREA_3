    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apellidos', models.BooleanField(max_length=255, verbose_name='Apellidos de autor')),
                ...
                ('echa_creacion', models.DateField(auto_now_add=True, verbose_name='Fecha de Creacion')),
            ],
            options={
                'verbose_name': 'Autor',
